...
class OracleLstm(object):
    ...
    def create_recurrent_unit(self, params):
        ...
        self.Wi = tf.Variable(tf.random.normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=111))
        self.Ui = tf.Variable(tf.random.normal([self.hidden_dim, self.hidden_dim], 0.0, 1000000.0, seed=211))
        self.bi = tf.Variable(tf.random.normal([self.hidden_dim, ], 0.0, 1000000.0, seed=311))

        self.Wf = tf.Variable(tf.random.normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=114))
        self.Uf = tf.Variable(tf.random.normal([self.hidden_dim, self.hidden_dim], 0.0, 1000000.0, seed=115))
        self.bf = tf.Variable(tf.random.normal([self.hidden_dim, ], 0.0, 1000000.0, seed=116))

        self.Wog = tf.Variable(tf.random.normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=997))
        self.Uog = tf.Variable(tf.random.normal([self.hidden_dim, self.hidden_dim], 0.0, 1000000.0, seed=998))
        self.bog = tf.Variable(tf.random.normal([self.hidden_dim, ], 0.0, 1000000.0, seed=999))

        self.Wc = tf.Variable(tf.random.normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=110))
        self.Uc = tf.Variable(tf.random.normal([self.hidden_dim, self.hidden_dim], 0.0, 1000000.0, seed=111))
        self.bc = tf.Variable(tf.random.normal([self.hidden_dim, ], 0.0, 1000000.0, seed=112))
        params.extend([
