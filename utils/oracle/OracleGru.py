...
class OracleGru(object):
    ...
    def create_recurrent_unit(self, params):
        ...
        self.Wz = tf.Variable(tf.random.normal([self.emb_dim, self.hidden_dim], 0.0, 0.1, seed=111))
        self.Uz = tf.Variable(tf.random.normal([self.hidden_dim, self.hidden_dim], 0.0, 0.1, seed=211))
        self.bz = tf.Variable(tf.random.normal([self.hidden_dim, ], 0.0, 0.1, seed=311))

        self.Wr = tf.Variable(tf.random.normal([self.emb_dim, self.hidden_dim], 0.0, 0.1, seed=112))
        self.Ur = tf.Variable(tf.random.normal([self.hidden_dim, self.hidden_dim], 0.0, 0.1, seed=212))
        self.br = tf.Variable(tf.random.normal([self.hidden_dim, ], 0.0, 0.1, seed=312))

        self.W = tf.Variable(tf.random.normal([self.emb_dim, self.hidden_dim], 0.0, 0.1, seed=113))
        self.U = tf.Variable(tf.random.normal([self.hidden_dim, self.hidden_dim], 0.0, 0.1, seed=213))
        self.b = tf.Variable(tf.random.normal([self.hidden_dim, ], 0.0, 0.1, seed=313))
